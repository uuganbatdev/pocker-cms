                ...
                <Row className="justify-content-center">
                  <Col xl={8}>
                    <div>
                      ...
                      <div>
                        <h5>
                          <Link to="blog-details.html" className="text-dark">
                    ...
                    <div className="mt-5">
                      ...
                      <div className="list-group list-group-flush">
                        ...
                        <Link
                          ...
                          className="list-group-item text-muted"
                        >
                          <i className="mdi mdi-circle-medium mr-1"></i> Drawing
                          a sketch
                        </Link>
                        ...
                        <Link
                          ...
                          className="list-group-item text-muted"
                        >
                          <i className="mdi mdi-circle-medium mr-1"></i> Project
                    ...
                    <div className="mt-5">
                      ...
                      <div className="list-group list-group-flush">
                        <Link
                          ...
                          className="list-group-item text-muted"
                        >
                          <i className="mdi mdi-circle-medium mr-1"></i> Coffee
                          with Friends
                        </Link>
                        ...
                        <Link
                          ...
                          className="list-group-item text-muted"
                        >
                          <i className="mdi mdi-circle-medium mr-1"></i> Neque
                          porro quisquam est
                        </Link>
                        ...
                        <Link
                          ...
                          className="list-group-item text-muted"
                        >
                          <i className="mdi mdi-circle-medium mr-1"></i> Quis
                          autem vel eum iure
                        </Link>
                        ...
                        <Link
                          ...
                          className="list-group-item text-muted"
                        >
                          <i className="mdi mdi-circle-medium mr-1"></i> Cras mi
                          eu turpis
                        </Link>
