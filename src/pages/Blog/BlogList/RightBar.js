          ...
          <CardBody className="p-4">
              ...
              <ul className="list-unstyled font-weight-medium">
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right mr-1"></i> Design
                  </a>
                </li>
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right mr-1"></i> Development{" "}
                    <span className="badge badge-soft-success badge-pill float-right ml-1 font-size-12">
                      04
                    </span>
                  </a>
                </li>
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right mr-1"></i> Business
                  </a>
                </li>
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                ...
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right mr-1"></i> Travel
                    <span className="badge badge-soft-success badge-pill ml-1 float-right font-size-12">
                      12
                    </span>
                  </a>
                </li>
            ...
            <div>
              ...
              <ul className="list-unstyled font-weight-medium">
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right mr-1"></i> 2020{" "}
                    <span className="badge badge-soft-success badge-pill float-right ml-1 font-size-12">
                      03
                    </span>
                  </a>
                ...
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right mr-1"></i> 2019{" "}
                    <span className="badge badge-soft-success badge-pill float-right ml-1 font-size-12">
                      06
                    </span>
                  </a>
                ...
                <li>
                  <a href="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right mr-1"></i> 2018{" "}
                    <span className="badge badge-soft-success badge-pill float-right ml-1 font-size-12">
                      05
                    </span>
                  </a>
