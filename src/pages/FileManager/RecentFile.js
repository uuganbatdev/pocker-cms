...
const RecentFile = props => {
  const recentfile = [
    {
      id: 1,
      icon: "mdi mdi-file-document font-size-16 align-middle text-primary mr-2",
      file: "index.html",
    ...
    {
      id: 2,
      icon: "mdi mdi-folder-zip font-size-16 align-middle text-warning mr-2",
      file: "Project-A.zip",
    ...
    {
      id: 3,
      icon: "mdi mdi-image font-size-16 align-middle text-muted mr-2",
      file: "Img-1.jpeg",
    ...
    <React.Fragment>
      <div className="mt-4">
        <div className="d-flex flex-wrap">
          <h5 className="font-size-14 mr-3">Recent Files</h5>
